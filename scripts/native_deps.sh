...
DEPENDENCIES="$DEPENDENCIES_ROOT/dependencies"
...
UTIL_LINUX_VERSION_PATCH="2"
UTIL_LINUX_VERSION="$UTIL_LINUX_VERSION_MAJOR.$UTIL_LINUX_VERSION_PATCH"
UTIL_LINUX_ARCHIVE="util-linux-$UTIL_LINUX_VERSION.tar.xz"
UTIL_LINUX_URL="https://www.kernel.org/pub/linux/utils/util-linux/v$UTIL_LINUX_VERSION_MAJOR/$UTIL_LINUX_ARCHIVE"
...
GLIB2_VERSION_MAJOR="2.68"
GLIB2_VERSION_PATCH="1"
...
GC_VERSION="8.0.4"
GC_ARCHIVE="gc-$GC_VERSION.tar.gz"
GC_URL="https://www.hboehm.info/gc/gc_source/$GC_ARCHIVE"
GC_DIR="gc-$GC_VERSION"
GC_INSTALL="$INSTALL/$GC_DIR"
...
LIBICONV_ARCHIVE="libiconv-$LIBICONV_VERSION.tar.gz"
LIBICONV_URL="https://ftp.gnu.org/pub/gnu/libiconv/$LIBICONV_ARCHIVE"
LIBICONV_DIR="libiconv-$LIBICONV_VERSION"
LIBICONV_INSTALL="$INSTALL/$LIBICONV_DIR"

LIBUNISTRING_VERSION="0.9.10"
LIBUNISTRING_ARCHIVE="libunistring-$LIBUNISTRING_VERSION.tar.gz"
LIBUNISTRING_URL="https://ftp.gnu.org/gnu/libunistring/$LIBUNISTRING_ARCHIVE"
LIBUNISTRING_DIR="libunistring-$LIBUNISTRING_VERSION"
LIBUNISTRING_INSTALL="$INSTALL/$LIBUNISTRING_DIR"

GUILE_VERSION_MAJOR="2.2"
GUILE_VERSION_PATCH="7"
...
FRIBIDI_INSTALL="$INSTALL/$FRIBIDI_DIR"

# Do not upgrade beyond 1.48.2, it uses much more memory:
# https://gitlab.gnome.org/GNOME/pango/-/issues/543
PANGO_VERSION_MAJOR="1.48"
PANGO_VERSION_PATCH="2"
